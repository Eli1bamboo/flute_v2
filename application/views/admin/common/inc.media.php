    ...
    <form id="media-form" class="ajax_form" action="<?= $form_action?>" method="post" enctype="multipart/form-data">
        ...
        if($this->bitauth->is_admin())
		{
			...
			if($attr['descriptions'])
			{
					...
					echo '<label for="file_title">Titulo de la imagen</label>';
					echo "<br clear='all'>";
					echo '<span class="form_input">
							<textarea id="file_title" class="title" type="text" value="" name="file_title" class="tinymce"></textarea>
							</span>';
					echo '</div>';
					echo "<br clear='all'>";
					echo '<div class="form_field" style="width:40% !important;">';
					echo '<label for="file_description">Texto de la imagen</label>';
					echo "<br clear='all'>";
					echo '<span class="form_input">
                        ...
                        ?>
                            <div class="col-xs-6 col-md-3">
                                <span class="thumbnail" style="text-align:center;">
                                    ...
                                    <br />
									<br />
									<strong>Texto de la imagen:</strong>
									<br />
									<?
									if (strlen($file->file_description) > 10){
											$description = substr($file->file_description, 0, 50) . '...';
										}
									?>
									<i><?= $description; ?></i>
                                    <br />
