...
class admin_forms {
	...
	function input_block($field_name,$field_attrs, $prev_val = '', $description = '')
	{
		...
		switch($this->field_attrs['type'])
		{
			...
			case 'form_text':
				$str = $this->_form_text();
				break;
			case 'contact_form_text':
				$str = $this->_contact_form_text();
				break;
			case 'contact_form_text_lg':
				$str = $this->_contact_form_text_lg();
				break;
			case 'password':
				$str = $this->_password();
				break;
			...
			case 'textarea':
				...
				break;
			case 'form_textarea':
				$str = $this->_form_textarea();
				break;
			case 'contact_form_textarea':
				$str = $this->_contact_form_textarea();
				break;
			case 'select':
				$str = $this->_select();
				break;
			case 'contact_form_select':
				$str = $this->_contact_form_select();
				break;
			case 'select_address':
	...
	{
		$this->common_attrs =  "name='".$this->field_name."' class='form-control datepicker ".($this->field_attrs['class'] ? $this->field_attrs['class'] : "")."' ".($this->field_attrs['style'] ? " style='".$this->field_attrs['style']."' " : "")." ".$this->field_attrs['attrs'];
		$this->common_attrs .= $this->field_attrs['disabled'] ? "disabled='disabled'" : "";
		...
		$str .= '<div class="col-sm-12 col-md-3">
                     <input type="text"  id="'.$this->field_name.'" '.$this->common_attrs.' value="'.($this->prev_val && ($this->prev_val != '0000-00-00 00:00:00') ? dateFormat($this->prev_val,'d/m/Y') : date('d/m/Y')).'">
                 ';
		$str .= $this->description? "<div class='clearfix'></div><small>".$this->description."</small>" : "";
		$str .= "</div></span>";
		return $str;
	...
	protected function _form_textarea()
	{
	...
	protected function _contact_form_textarea()
	{
		$str .=	"<div class='col-xs-12'>";
		$str .=	"	<div class='form-group'>";
		$str .=	"		<label for='".$this->field_name."'>".$this->field_attrs['label']."</label>";
		$str .=	"		<textarea class='form-control' rows='13' id='".$this->field_name."' ".$this->common_attrs." >".$this->prev_val."</textarea>";
	...
	{
		$str = "<label  class='".$this->field_attrs['class']."' class='col-md-2 col-sm-12 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<span class='form_input'>";
	...
	protected function _contact_form_text()
	{
		$val = str_replace('"','\'',$this->prev_val);
		...
		$str .= "	<div class='form-group'>";
		$str .= "		<label for='".$this->field_name."'>".$this->field_attrs['label']."</label>";
		$str .=	"		<input class='form-control' type='text' id='".$this->field_name."' ".$this->common_attrs." value=\"".$val."\"/>";

		return $str;
	}

	protected function _contact_form_text_lg()
	{
		$val = str_replace('"','\'',$this->prev_val);
	...
	protected function _contact_form_select()
	{
		if(isset($this->field_attrs['source_table']))
		{
			$source_fields = implode(",",$this->field_attrs['source_fields']);
		...
		$str .="<select class'form-control'  id='".$this->field_name."' ".$this->common_attrs.">";
