...
class admin_forms {
	...
	{
		$str = "<label for='".$this->field_name."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<div class='col-sm-10'>";	
		$str .=	"<input type='".$this->field_attrs['type']."' id='".$this->field_name."' ".$this->common_attrs."/>";
		$str .= $this->description? "<div class='field_description'>".$this->description."</div>" : "";
		$str .= "</div>";
		return $str;				
	}
	...
	{
		$str .= "<label for='".$this->field_name."' class='col-sm-2 control-label'>Seleccionar imagen</label>";
	...
	protected function _date()
	{
		...
		$str = "<label for='".$this->field_name."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<span class='form_input'>";
		$str .= "<div>".selectDates($prev_val, $this->field_name, $this->field_attrs['class'],$this->field_attrs['offset_up'] ? $this->field_attrs['offset_up'] : 1,$this->field_attrs['offset_down'] ? $this->field_attrs['offset_down'] : 10)."</div>";
		$str .= $this->description? "<div class='field_description'>".$this->description."</div>" : "";
		$str .= "</span>";
		return $str;			
	}
	...
	protected function _date_time()
	{
		$str = "<label for='".$this->field_name."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<span class='form_input'>";
		$str .= "<div><input type='text' id='".$this->field_name."' ".$this->common_attrs." class='datepicker' value='".dateFormat($this->prev_val,"Y-m-d H:i")."'/></div>";
		$str .= $this->description? "<div class='field_description'>".$this->description."</div>" : "";
		$str .= "</span>";
		return $str;				
	}
	...
	protected function _radio()
	{
		$str = "<label for='".$this->field_name."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<span class='form_input'>";
		$str .='<div  class="btn-group btn-group-sm col-sm-10" data-toggle="buttons">';
		if(is_array($this->field_attrs['options']))
		{
			foreach($this->field_attrs['options'] as $option_id => $option)
			{
				$str .= "<label class='btn btn-default ".($option['value'] == $this->prev_val ? 'active' : '')."' for='".$option['value']."_".$option_id."'><input type='radio' value='".$option['value']."' id='".$option['value']."_".$option_id."'".$this->common_attrs." ".($option['value'] == $this->prev_val ? 'checked' : '')."/>".$option['label']."</label>";	
			}
		}
		$str .="</div>";
		$str .= $this->description? "<div class='clear'></div><div class='field_description left'>".$this->description."</div>" : "";
		$str .= "</span>";
		return $str;						
	}
	...
	protected function _checkbox()
	{
		$str = "<label for='".$this->field_name."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .='<div  class="btn-group btn-group-sm col-sm-10" data-toggle="buttons">';
		$str .= "<label for='".$this->field_name."_1' class='btn btn-success ".($this->prev_val ? "active" : "")."' ><input type='radio' value='1'  id='".$this->field_name."_1'".$this->common_attrs." ".($this->prev_val ? "checked" : "")."/>Si</label>";
		$str .= "<label for='".$this->field_name."_0' class='btn btn-danger ".(!$this->prev_val ? "active" : "")."'><input type='radio' value='0'  id='".$this->field_name."_0'".$this->common_attrs." ".(!$this->prev_val ? "checked" : "")."/>No</label>";
		$str .= "</div>";
		$str .= $this->description? "<div class='clear'></div><div class='field_description left'>".$this->description."</div>" : "";
		$str .= "</span>";
		return $str;			
	...
	protected function _textarea()
	{
		...
		{
			$str = "<label for='".$this->field_name."'>".$this->field_attrs['label']."</label>";
	...
	{
		$str = "<label  class='".$this->field_attrs['class']."' class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<span class='form_input'>";
		$str .= "<input type='file' id='".$this->field_name."' ".$this->common_attrs."/>";	
		$str .= $this->description? "<div class='field_description'>".$this->description."</div>" : "";
		$str .= "</span>";
	...
	*/
	protected function _select_address()
	{
		...
		if($this->field_attrs['with_departments'])
		{
			...
			$str .= "<label for='".$this->field_attrs['department_field_name']."' class='col-sm-2 control-label'>".$this->field_attrs['department_label']."</label>";
			$str .= "<div class='col-sm-10'>";
	...
	protected function _multiselect()
	{
		...
		if(is_array($this->field_attrs['options']))
		{
			foreach($this->field_attrs['options'] as $option)
			{
				...
				if(in_array($option['value'], $this->prev_vals))
					$checked = "checked='checked'";
				else
					$checked = "";

				$str .= "<label for='".$this->field_name."[".$option['value']."]'>".$option['label']."</label>";
				$str .= "<input type='checkbox' {$checked} name='".$this->field_name."[".$option['value']."]' id='".$this->field_name."[".$option['value']."]'><br clear='all' />";
			}
		}
	...
	{
		$str = "<label class='col-sm-2 control-label'>".$this->field_attrs['label']."</label>";
		$str .= "<div class='col-sm-10'>";
		if($this->prev_val)
		{
